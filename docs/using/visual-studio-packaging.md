 ...
 **Tip:** In this case you may simply need to restart Visual Studio so the Package Manager Console will have loaded all the package tools. You may have to click on the Package Manager Console if it is not visible so it loads properly.
